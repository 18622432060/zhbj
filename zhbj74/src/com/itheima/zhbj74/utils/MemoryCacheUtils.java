...
public class MemoryCacheUtils {
	...
	// private HashMap<String, SoftReference<Bitmap>> mMemoryCache = new HashMap<String, SoftReference<Bitmap>>();//软引用
	...
	public MemoryCacheUtils() {
		...
		LogUtils.v("maxMemory:" + maxMemory);
		mMemoryCache = new LruCache<String, Bitmap>((int) (maxMemory / 8)) {//防止app挂掉 使用app的8分之一内存
			// 返回每个对象的大小,需要开发者自己计算
			@Override
			protected int sizeOf(String key, Bitmap value) {
//				 int byteCount = value.getByteCount();//api 12 版本
